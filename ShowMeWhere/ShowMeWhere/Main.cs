...
namespace ShowMeWhere
{
    public class Main : ModBase
    {
        ...
        public static SettingHandle<bool> colorblindMode;

        public override void DefsLoaded()
        {
            base.DefsLoaded();
            Main.colorblindMode = base.Settings.GetHandle<bool>("colorblindMode", "Colorblind Mode".Translate(), null, true, null, null);
        }
